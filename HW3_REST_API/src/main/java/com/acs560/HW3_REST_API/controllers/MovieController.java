...
public class MovieController {
     ...
     * 
     * This method processes a Movie object provided in the request body,
     * adds it to the movie repository, and responds with a 201 Created status.
     * 
     * @param movie The Movie object to be added. It should contain all required
     *              fields to be stored in the repository.
     * @return A {@link ResponseEntity} indicating the outcome of the request. The response
     *         has a 201 Created status if the movie was successfully added.
     */
	@PostMapping
     ...
     * 
     * This method processes a Movie object provided in the request body,
     * updates the corresponding movie in the repository, and responds with a 200 OK status.
     * 
     * @param movie The Movie object with updated details. The movie should
     *              have a unique identifier that allows it to be found and updated in the repository.
     * @return A {@link ResponseEntity} indicating the outcome of the request. The response
     *         has a 200 OK status if the movie was successfully updated.
     */
    @PutMapping()
     ...
     * 
     * This method processes a Movie object provided in the request body,
     * deletes the corresponding movie from the repository, and responds with a 200 OK status.
     * 
     * @param movie The Movie object to be deleted. The movie should have
     *              a unique identifier that allows it to be found and removed from the repository.
     * @return A {@link ResponseEntity} indicating the outcome of the request. The response
     *         has a 200 OK status if the movie was successfully deleted.
     */
    @DeleteMapping()
