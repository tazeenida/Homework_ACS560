package com.acs560.HW4_REST_API.services.impl;
...
public class MoviesServiceImpl implements MoviesService {
	 ...
	 * @return a list of {@link Movie} objects that were released between startYear and endYear
	...
	public List<Movie> getMoviesByReleaseYearRange(int startYear, int endYear) {
	    ...
	    return movieRepository.findMoviesByReleaseYearBetween(startYear, endYear);
	}
